...
import type { AuthorProps, CollectionProps, PermissionProps, SolutionProps } from './types'
...
export default function Solution({
  ...
  const canEdit = collection.cid === "demo" || canEditSolution(solution, permission, authors);
