    ...
    <div className="p-8 md:py-24 whitespace-pre-wrap break-words">
      <div className="w-128 sm:w-144 md:w-160 max-w-full mx-auto">
        <div className="flex flex-wrap gap-x-12 gap-y-6 mb-6">
          {/* TODO: blue shadow */}
          <Link href={`/c/${collection.cid}/add-problem`} prefetch={true} className="shrink-0 grow inline-block py-3 px-10 text-center rounded-xl bg-sky-500 hover:bg-sky-600 text-slate-50 font-bold text-base soft-shadow-xl">Add Problem</Link>
