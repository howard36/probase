  ...
  return (
    <div className="p-8 md:py-24 whitespace-pre-wrap break-words">
      <div className="w-128 sm:w-144 md:w-160 max-w-full mx-auto">
        ...
        <div className="my-8">
          <div className="pt-2 relative mx-auto text-slate-600">
            <form>
              <input type="search" placeholder="Search" value={query} onChange={handleChange} className="border-2 border-slate-300 bg-white h-10 w-full pl-4 pr-12 rounded-lg text-sm focus:outline-none" />
