...
- Searching reads the statements of locked problems, so a Serious testsolver can learn words in a statement they may not read yet by watching which locked cards match. This may be worth treating as a bug: the search should look only at the title for locked problems.
